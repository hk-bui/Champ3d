...
draw2d = f_femm_draw_straightrect(draw2d,'id_draw2d','plateDo',...
            'center',[0 -hPlateUp-dgap-hPlateDo/2],...
            'r_len',lPlate,'theta_len',hPlateDo);
draw2d = f_femm_draw_straightrect(draw2d,'id_draw2d','dgap',...
            'center',[0 -hPlateUp-dgap/2],...
            'r_len',lPlate,'theta_len',dgap);
...
f_femm_set_block(draw2d,'id_draw2d','dgap' ,'method','center','block_name','air'  ,'meshsize',meshsize);
