...
c3dobj = f_add_mesh2d(c3dobj,'id_mesh2d','mesh2d_light','build_from','geo1d',...
...
c3dobj = f_add_design3d(c3dobj,'id_design3d','Inf_coil_over_plate','id_mesh3d','mesh1');

c3dobj = f_add_econductor(c3dobj,'id_design3d','Inf_coil_over_plate',...
                          'id_econductor','plate', ...
...
c3dobj = f_add_econductor(c3dobj,'id_dom3d','plate','sigma',tsigPlate);
...
c3dobj = f_add_nomesh(c3dobj,'id_dom3d','coil');
