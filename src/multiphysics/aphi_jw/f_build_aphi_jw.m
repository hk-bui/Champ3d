function design3d = f_build_aphi_jw(design3d,varargin)
...
%--------------------------------------------------------------------------
design3d = f_build_magnet_aphi(design3d);
%--------------------------------------------------------------------------
...
if design3d.aphi.fr ~= 0
    K11 = design3d.mesh.R.' * ...
         (design3d.aphi.SWfWf + design3d.aphi.SWfWfAir) * ...
          design3d.mesh.R;
    ...
    S = [S K12];
    S = [S; K12.' K22];
    RHS = design3d.aphi.coilRHS + design3d.aphi.fixedRHS + design3d.aphi.magnetRHS;
