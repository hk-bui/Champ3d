...
mesOpt.y{3}  = {hPlateUp-esurf, 2*msize, 'lin'};
mesOpt.y{4}  = {esurf, 1, 'lin'};
mesOpt.y{5}  = {agap, msize, 'lin'};
mesOpt.y{6}  = {hCoil, 2*msize, 'lin'};
mesOpt.y{7}  = {lPlate, 2*msize, 'log+'};
% ---
...
i_elem_2d_plate_up = f_find_dom_xy(t2d,{[2 3 4]},{[3 4]});
i_elem_2d_esurf = f_find_dom_xy(t2d,{[2 3 4]},{[4]});
i_elem_2d_coil  = f_find_dom_xy(t2d,{[3]},{[6]});
% ---
