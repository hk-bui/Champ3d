function mesh = f_mdsquad_2(node,elem,varargin)
% F_MDSQUAD ...
% mesh = F_MDSQUAD(node,elem)
% mesh = F_MDSQUAD(node,elem,'full')
% mesh = F_MDSQUAD(node,elem,'edge','face','interface','interedge','bound','D','R','G')
%--------------------------------------------------------------------------
% CHAMP3D PROJECT
