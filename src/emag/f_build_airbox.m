...
%--------------------------------------------------------------------------
tic;
to_be_rebuilt = c3dobj.emdesign3d.(id_emdesign3d).airbox.(id_airbox).to_be_rebuilt;
if to_be_rebuilt
    %----------------------------------------------------------------------
    ...
    c3dobj.emdesign3d.(id_emdesign3d).airbox.(id_airbox).id_face = id_face;
    c3dobj.emdesign3d.(id_emdesign3d).airbox.(id_airbox).id_edge = id_edge;
    %----------------------------------------------------------------------
    ...
    switch em_model
        case {'fem_aphijw','fem_aphits'}
            ...
            % --- Output
            c3dobj.emdesign3d.(id_emdesign3d).airbox.(id_airbox).id_elem = id_elem;
            c3dobj.emdesign3d.(id_emdesign3d).airbox.(id_airbox).id_node = id_node;
