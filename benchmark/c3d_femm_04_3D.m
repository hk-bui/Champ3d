...
mesOpt.x{2}  = {lPlate/2 - lCoil/2, 2*msize, 'log-'};
mesOpt.x{3}  = {lCoil, 2*msize, 'lin'};
mesOpt.x{4}  = {lPlate/2 - lCoil/2, 2*msize, 'log+'};
...
%% Layer
layer = [];
layer = f_add_layer(layer,'id_layer','allLayer1','thickness',lPlate/2,'nb_slice',5,'z_type','lin');
layer = f_add_layer(layer,'id_layer','lLine','thickness',1e-6,'nb_slice',1,'z_type','lin');
layer = f_add_layer(layer,'id_layer','allLayer2','thickness',lPlate/2,'nb_slice',5,'z_type','lin');
...
design3d = f_add_econductor(design3d,'id_dom3d','coil','sigma',tsigCoil);
